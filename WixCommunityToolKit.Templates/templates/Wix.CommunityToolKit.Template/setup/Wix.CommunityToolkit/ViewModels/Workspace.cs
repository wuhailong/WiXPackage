...
namespace Wix.CommunityToolKit.ViewModels
{
		...
		private void SwitchExtendedTheme()
		{
			switch (_selectedTheme.Item1)
			{
				case "Vs2013DarkTheme":
					...
					Application.Current.Resources.MergedDictionaries[1].Source = new Uri("pack://application:,,,/Wix.CommunityToolKit;component/Themes/DarkBrushsExtended.xaml");
					break;
				case "Vs2013LightTheme":
					...
					Application.Current.Resources.MergedDictionaries[1].Source = new Uri("pack://application:,,,/Wix.CommunityToolKit;component/Themes/LightBrushsExtended.xaml");
					break;
				case "Vs2013BlueTheme":
					//TODO: Create new color resources for blue theme
					Application.Current.Resources.MergedDictionaries[0].Source = new Uri("pack://application:,,,/MLib;component/Themes/LightTheme.xaml");
					Application.Current.Resources.MergedDictionaries[1].Source = new Uri("pack://application:,,,/Wix.CommunityToolKit;component/Themes/BlueBrushsExtended.xaml");
					break;
				default:
					break;
			}
